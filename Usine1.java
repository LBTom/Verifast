/*@predicate tache(Tache tache; int temps_necessaire, int gain) = tache.temps_necessaire |-> temps_necessaire &*& tache.gain |-> gain &*&
	     temps_necessaire > 0 &*& 
	     gain > 0; 
...
class Usine
{
	...
	@*/
	/*@ensures gain > (temps_necessaire * salaire_horaire) ? usine(this, balance-salaire_horaire * temps_necessaire+gain) : usine(this, balance) &*&
